...
# python tools/analysis_tools/benchmark.py work_dirs/fastvit-t12-former/fastvit_t12_focalloss.py work_dirs/fastvit-t12-former/best_mIoU_iter_7300.pth
try:
...
# python tools/analysis_tools/get_flops.py work_dirs/fastvit-t12-former/20240406_194741/vis_data/config.py --shape 640 480
def parse_args():
